...
} elseif ( ! empty( $field['default'] ) && ! empty( $field['taxonomy'] ) ) {
	$lk_term  = get_term_by( 'slug', $field['default'], $field['taxonomy'] );
	$selected = $lk_term->term_id;
} else {
	$selected = '';
}
...
wp_dropdown_categories(
	apply_filters(
		'job_manager_term_select_field_wp_dropdown_categories_args',
		[
