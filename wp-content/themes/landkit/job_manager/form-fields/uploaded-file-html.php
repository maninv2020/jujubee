...
<div class="job-manager-uploaded-file">
	...
	if ( 'image' === wp_ext2type( $extension ) ) :
		?>
		<span class="job-manager-uploaded-file-preview"><img src="<?php echo esc_url( $image_src ); ?>" /> <a class="job-manager-remove-uploaded-file" href="#">[<?php echo esc_html__( 'remove', 'landkit' ); ?>]</a></span>
	<?php else : ?>
		<span class="job-manager-uploaded-file-name"><code><?php echo esc_html( basename( $image_src ) ); ?></code> <a class="job-manager-remove-uploaded-file" href="#">[<?php echo esc_html__( 'remove', 'landkit' ); ?>]</a></span>
	<?php endif; ?>
